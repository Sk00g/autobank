...
DOB
tab x2
2877, 223 check color for 0xF4B04F -> means duplicate
down x1 for female, x2 for male
2206, 807 for single | 2474, 808 for cohab | 3011, 807 for undisclosed | 2207, 831 for married
3832, 317 down, hold and move to 3832, 716 and release
2206, 171 no fixed address
2922, 224 housing undisclosed
3011, 680 ethnicity undisclosed
2207, 915 yes student | 2206, 939 no student | 2205, 964 unknown
2245, 486 phone number add
type phone
scroll down a bunch
3732, 836 add household member
    2475, 239 select last name
    last name
    tab 
    first name 
    tab
    ...
    gender
    tab
    down 2 spouse | 3 child | 10 common-law
    enter
    2669, 423 undisclosed ethnicity
    pick location
    2449, 669 yes student | 2448, 695 no | 2449, 720 undisclosed
    3231, 754/867 save changes

3726, 966 - Save and next
2248, 547 - add income
shift tab
down 
    child benefits
    ...
    PT
2246, 535 - primary
    3737, 736 - save and next with 1 member
    3738, 871 - save and next with 2 members
    
3744, 769
3747, 699 - save and next
2762, 193 - notes
3765, 353 - new note
3113, 487 - save note
2611, 192 - check for green as 0x43A543

2857, 227 - Check for orange duplicate (0xF4B04F)
2872, 292 - see more
2902, 438 - start search for red here (0xE66252)
click once you find red
3101, 326 - confirm duplicate dismissal
"""
